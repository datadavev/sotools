...
Three options for linking to external metadata documents are described here, with examples.

`SO:subjectOf` metadata links
-----------------------------
...
The links and other information can be extracted using `func:sotools.common.getDatasetMetadataLinksFromSubjectOf`.
For example:

.. jupyter-execute:: examples/code/eg_metadatalinks_subjectof_02.py


`SO:about` metadata links
-------------------------
...
The links and other information can be extracted using `func:sotools.common.getDatasetMetadataLinksFromAbout`.
For example:

.. jupyter-execute:: examples/code/eg_metadatalinks_about_02.py


`SO:encooding` metadata links
-----------------------------
...
The links and other information can be extracted using `func:sotools.common.getDatasetMetadataLinksFromEncoding`.
For example:
